    ...
    public void GenerateXml_ForGenericTypeDefinition ()
    {
      ...
      var expectedOutput = new XElement (
          ...
          new XElement (
              ...
              _outputFormatter.CreateKeywordMarkup (_typeModifierUtility.GetTypeModifiers (involvedType1.Type)),
    ...
    public void GenerateXml_InvolvedTypes ()
    {
      ...
      var expectedOutput = new XElement (
          ...
          new XElement (
              ...
              new XAttribute ("is-mixin", false),
              new XAttribute ("is-generic-definition", false),
              _outputFormatter.CreateKeywordMarkup (_typeModifierUtility.GetTypeModifiers (involvedType2.Type)),
          ...
          new XElement (
              ...
              new XAttribute ("is-generic-definition", false),
              _outputFormatter.CreateKeywordMarkup (_typeModifierUtility.GetTypeModifiers (involvedType3.Type)),
          ...
          new XElement (
              ...
              new XAttribute ("is-mixin", true),
              new XAttribute ("is-generic-definition", false),
              _outputFormatter.CreateKeywordMarkup (_typeModifierUtility.GetTypeModifiers (involvedType4.Type)),
