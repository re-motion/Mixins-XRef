...
rem echo [4] ... Docs build ^(x86-debug if not present, docs^)
rem echo           Requires Sandcastle Help File Builder to be installed!
...
rem if %ERRORLEVEL%==4 goto run_docs_build
